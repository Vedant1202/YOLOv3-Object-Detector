...
def parse_cfg(cfgfile):
    with open(cfgfile, 'r') as file:
        lines = [line.rstrip('\n') for line in file if line != '\n' # Strip lines of unnnecessary markers
                 and line[0] != '#']
    holder = {}
    blocks = []
    for line in lines:
    ...
    blocks.append(holder)
    return blocks # return a list of key-value pairs having the configurations
...
def YOLOv3Net(cfgfile, model_size, num_classes):
    ...
    for i, block in enumerate(blocks[1:]):
        ...
        # Yolo detection layer
            ...
            # Use the sigmoid function to convert into range of 0 – 1.
            ...
            # Concatenate the results for each scale 
